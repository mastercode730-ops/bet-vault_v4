...
const faqs = [
  ...
  { q: "What sports are available on BetVault?", a: "Available sports can change. Check the current sports or Gaming section on the website for the latest list and availability." },
