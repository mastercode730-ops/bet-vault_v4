...
const WA =
  "https://wa.me/918360750829?text=Hi%20Bet%20Vault%2C%20I%20need%20more%20information%20on%20this";
    ...
    <>
      ...
      <div
        style={{
          ...
          height: "2px",
          background:
            "linear-gradient(90deg,#8B0000,#C0392B,#D4AF37,#C0392B,#8B0000)",
        }}
      />
        ...
        >
          ...
          >
            {navLinks.map((l) => (
              <button
                key={l.label}
                className={`nav-item${active === l.href ? " active" : ""}`}
                onClick={() => {
                  scrollTo(l.href);
                  setActive(l.href);
                }}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <a
              ...
              className="hide-mob btn-outline-gold"
              style={{
                padding: "7px 16px",
                borderRadius: "6px",
                fontSize: "13px",
        ...
        {open && (
          ...
          >
            ...
            >
              ...
              >
                <WaIcon size={18} /> WhatsApp +91 83607 50829
              </a>
            </div>
          </div>
        )}
      ...
      >
        <WaIcon size={18} />
        <span id="float-cta" style={{ display: "none" }}>
          Get Your ID
        </span>
      </a>
